...
def plotter_v2(x,p0,p1,u0,u1,spl1=None,spl2=None,spl3=None,spl4=None,pos=0.7,cne=5,intr='s',x_label='Spline0',spl1_label='Spline1',spl2_label='Spline2',spl3_label='Spline3',spl4_label='Spline4',title='3D Projection',height=700,width=1200):
    if intr=='s':
        fig=plt.figure(figsize=(20,20))
        gs=gridspec.GridSpec(2,3,figure=fig,height_ratios=[1,2])
        ...
        fig.update_layout(title=title,scene=dict(xaxis_title='X',yaxis_title='Y',zaxis_title='Z',camera=dict(eye=dict(x=1,y=-1,z=1))),font=dict(size=15,family='Times New Roman'),autosize=False,height=height,width=width)
        fig.update_scenes(camera_projection_type='orthographic')
        return fig